...
const ImageZoomModal = ({ imageUrl, onClose }: { imageUrl: string; onClose: () => void; }) => (
    <div className="fixed inset-0 bg-opacity-75 flex items-center justify-center z-[100]" onClick={onClose}>
...
const ShareModal = ({ product, onClose }: { product: Product; onClose: () => void; }) => (
    <div className="fixed inset-0 bg-opacity-60 flex items-center justify-center z-[100]" onClick={onClose}>
